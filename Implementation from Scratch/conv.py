...
class Conv3x3:
  ...
  #----------------------------------#
  # REGION ITERATOR (SLIDING 3x3 WINDOW)
  #----------------------------------#
  ...
  def forward(self, input):
    ...
    # Extra Note: Each filter produces one channel in the output.
  ...
  #----------------------------------#
  # BACKWARD PASS (FILTER GRADIENT UPDATE)
  #----------------------------------#
  def backprop(self, d_L_d_out, learn_rate):
    ...
    # Extra Note: Backprop computes gradient wrt each filter.
